...
<form method="POST" action="https://sirs.activehosted.com/proc.php" id="_form_2_" class="_form _form_2 _inline-form  _dark" novalidate>
  ...
  <div class="_form-content">
    <div class="_form_element _x86637356 _full_width _clear" >
      <div class="_form-title">
        Subscribe for Email Updates
      </div>
    </div>
    <div class="_form_element _x34468470 _full_width _clear" >
    ...
    <div class="_form_element _x88541941 _full_width " >
    ...
    <div class="_form_element _x78949609 _full_width " >
      <label class="_form-label">
        Email*
      </label>
      <div class="_field-wrapper">
...
(function() {
  ...
  var form_submit = function(e) {
    ...
    if (validate_form()) {
      ...
      _load_script('https://sirs.activehosted.com/proc.php?' + serialized + '&jsonp=true');
    }
    return false;
  };

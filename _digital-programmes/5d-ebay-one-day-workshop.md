...
<ul>
  <li>Introduction to eBay and global selling</li>
  <li>Learn how to set up your eBay and PayPal accounts</li>
  <li>Understand digital visual merchandising on eBay, and how to optimise your listing to maximise conversion</li>
  <li>How to manage customers expectations and customer service</li>
  </ul>
...
All fees inclusive of prevailing GST</em>
 ...
 <P> <center><a href="https://forms.gle/wNAtmTgcsqHvmCcb7" style="background-color:#06225e; border:white; color:white; padding: 10px 10px; text-align:center; display:inline-block; margin: 4px 2px; cursor:pointer;text-decoration:none;" target="_blank">Register Now</a></center>
